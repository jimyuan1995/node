							...
							var junkPt = f.createPoint(canvasWidth - 25, 25);
							...
							function setup() {
								// p5.createCanvas
								p.createCanvas(canvasWidth, canvasHeight).position(50,50);
							...
							function drawBackground() {
								...
								function drawGrid() {
									// p5.p.strokeWeight, p5.p.strokeJoin, p5.ROUND, p5.p.stroke, p5.translate, p5.line, p5.push, p5.pop
									p.push();
								...
								function drawLabel() {
									// p5.push, p5.textSize, p5.p.stroke, p5.p.strokeWeight, p5.p.fill, p5.text, p5.pop
									p.push();
							...
							function mousePressed() {
								var current = f.createPoint(mouseX, mouseY);
